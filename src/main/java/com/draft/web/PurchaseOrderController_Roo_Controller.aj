...
import com.draft.web.PurchaseOrderController;
...
privileged aspect PurchaseOrderController_Roo_Controller {
    ...
    void PurchaseOrderController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("purchaseOrder_dates_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
